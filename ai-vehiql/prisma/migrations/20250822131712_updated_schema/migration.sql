...
-- CreateEnum
CREATE TYPE "public"."BookingStatus" AS ENUM ('PENDING', 'COMPLETED', 'CONFIRMED', 'NO_SHOW', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "UserSavedCar_userId_carId_idx" ON "public"."UserSavedCar"("userId", "carId");
