...
function SearchBar({ className }) {
  ...
  const suggestAI = () => {
    ...
    // router.push(`/cars?q=${encodeURIComponent(suggestion)}`);
  };
...
export default function Home() {
  return (
    <main className="min-h-screen pt-16 sm:pt-20 bg-gradient-to-b from-white via-slate-50 to-white">
      {/* Hero */}
      <section
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto">
            Advanced AI-assisted search, verified listings, and instant test drive
            booking.
          </p>
          ...
          <div className="mt-8">
            ...
            <div className="mt-3 text-xs text-slate-500">
              Tip: Try queries like "electric SUV under 50k" or "Toyota Corolla
              2020".
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="inline-flex items-center justify-center h-14 w-14 rounded-full bg-blue-50 text-blue-700 mb-4 mx-auto">
